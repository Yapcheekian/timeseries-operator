...
import (
	...
	operatorv1 "github.com/Yapcheekian/timeseries-operator/api/v1"
)
...
//+kubebuilder:rbac:groups=operator.extend-k8s.io,resources=timeseriesdbs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.extend-k8s.io,resources=timeseriesdbs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.extend-k8s.io,resources=timeseriesdbs/finalizers,verbs=update
...
func (r *TimeseriesDBReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.WithValues("timeseriesdb", req.NamespacedName)
